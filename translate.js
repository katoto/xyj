    ...
    setTranslate = function (e) {
        ...
        a = {
            zh: {
                ...
                chooseTeam: "选择团队",
                withdraw: "全部提现",
                buyTip: "*宝石的价格会根据更多用户的购买数量而不断增长",
                drawTip: "*提示：最低10个EOS起提，本轮结束自动提现至账户",
                totalAward: "总收益",
                rebate: "分享奖励",
                withdrawAvailable: "可提现额度",
                yourGems: "你的宝石",
            ...
            en: {
                ...
                drawTip: "*Minimum withdrawal amount: 10 EOS；Your rewards will be automatically withdrawn to your EOS account if the round ends",
